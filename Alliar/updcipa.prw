...
/*/
//--------------------------------------------------------------------
User Function UPDCIPA( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tipo Mandato'															, ; //X3_TITULO
	'Tipo Mandato'															, ; //X3_TITSPA
	'Tipo Mandato'															, ; //X3_TITENG
	'Tipo de Mandato'														, ; //X3_DESCRIC
	'Tipo de Mandato'														, ; //X3_DESCSPA
	'Tipo de Mandato'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'IIF(INCLUI,U_ALRMDT2I("TNN_XTIPO"),TNN->TNN_XTIPO)'					, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	...
	'€'																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Constituição;2=Designação'											, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
...
aAdd( aSX3, { ;
	...
	'ID Fluig'																, ; //X3_TITSPA
	'ID Fluig'																, ; //X3_TITENG
	'ID Fluig Prox. Mandato'												, ; //X3_DESCRIC
	'ID Fluig Prox. Mandato'												, ; //X3_DESCSPA
	'ID Fluig Prox. Mandato'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;

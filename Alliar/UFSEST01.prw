...
/*/
//--------------------------------------------------------------------
User Function UFSEST01( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UFSEST01" )
				Else
					MsgStop( "Atualização não Realizada.", "UFSEST01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'POSICAO ESTOQUE PLERES'												, ; //X2_NOME
	'POSICAO ESTOQUE PLERES'												, ; //X2_NOMESPA
	'POSICAO ESTOQUE PLERES'												, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	{ 'SBZ'																	, .T. }, ; //X3_ARQUIVO
	{ '64'																	, .T. }, ; //X3_ORDEM
	{ 'BZ_XINTPLE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Int. Pleres'															, .T. }, ; //X3_TITULO
	{ 'Int. Pleres'															, .T. }, ; //X3_TITSPA
	{ 'Int. Pleres'															, .T. }, ; //X3_TITENG
	{ 'Integra Pleres'														, .T. }, ; //X3_DESCRIC
	{ 'Integra Pleres'														, .T. }, ; //X3_DESCSPA
	{ 'Integra Pleres'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 'ID Pleres'															, .T. }, ; //X3_DESCRIC
	{ 'ID Pleres'															, .T. }, ; //X3_DESCSPA
	{ 'ID Pleres'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SD3'																	, .T. }, ; //X3_ARQUIVO
	{ '93'																	, .T. }, ; //X3_ORDEM
	{ 'D3_XFLGPLE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Flag Pleres'															, .T. }, ; //X3_TITULO
	{ 'Flag Pleres'															, .T. }, ; //X3_TITSPA
	{ 'Flag Pleres'															, .T. }, ; //X3_TITENG
	{ 'Flag Pleres'															, .T. }, ; //X3_DESCRIC
	{ 'Flag Pleres'															, .T. }, ; //X3_DESCSPA
	{ 'Flag Pleres'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Data de Referência'													, .T. }, ; //X3_DESCRIC
	{ 'Data de Referência'													, .T. }, ; //X3_DESCSPA
	{ 'Data de Referência'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Sld. Estoque'														, .T. }, ; //X3_TITULO
	{ 'Sld. Estoque'														, .T. }, ; //X3_TITSPA
	{ 'Sld. Estoque'														, .T. }, ; //X3_TITENG
	{ 'Saldo em Estoque'													, .T. }, ; //X3_DESCRIC
	{ 'Saldo em Estoque'													, .T. }, ; //X3_DESCSPA
	{ 'Saldo em Estoque'													, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SZ9'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'Z9_QTDCON'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Qtd. Consum.'														, .T. }, ; //X3_TITULO
	{ 'Qtd. Consum.'														, .T. }, ; //X3_TITSPA
	{ 'Qtd. Consum.'														, .T. }, ; //X3_TITENG
	{ 'Quantidade Consumida'												, .T. }, ; //X3_DESCRIC
	{ 'Quantidade Consumida'												, .T. }, ; //X3_DESCSPA
	{ 'Quantidade Consumida'												, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
//
aHlpPor := {}
aAdd( aHlpPor, '[Alliar] Defini se o produto será' )
aAdd( aHlpPor, 'integrado ao sistema Pleres' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PBZ_XINTPLE", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "BZ_XINTPLE" )

//
// Helps Tabela SCP
//
aHlpPor := {}
aAdd( aHlpPor, '[Alliar] ID Pleres - Utilizado para' )
aAdd( aHlpPor, 'amarrar a envio do Pleres a requisição' )
aAdd( aHlpPor, 'criada no Protheus' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PCP_XIDPLE ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "CP_XIDPLE" )

//
// Helps Tabela SD3
//
aHlpPor := {}
aAdd( aHlpPor, '[Alliar] Identifica se a movimentação' )
aAdd( aHlpPor, 'sera possui integracao com Pleres' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PD3_XFLGPLE", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "D3_XFLGPLE" )
...
aHlpPor := {}
aAdd( aHlpPor, '[Alliar] Código do Produto' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ9_PRODUTO", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z9_PRODUTO" )

aHlpPor := {}
aAdd( aHlpPor, 'Data de Referência' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ9_DATA   ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z9_DATA" )

aHlpPor := {}
aAdd( aHlpPor, 'Saldo em Estoque' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ9_QUANT  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z9_QUANT" )

aHlpPor := {}
aAdd( aHlpPor, 'Quantidade Consumida' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ9_QTDCON ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z9_QTDCON" )

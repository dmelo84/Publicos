...
/*/
//--------------------------------------------------------------------
User Function UFSATF01( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UFSATF01" )
				Else
					MsgStop( "Atualização não Realizada.", "UFSATF01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'TIPOS DE BEM OCS'														, ; //X2_NOME
	'TIPOS DE BEM OCS'														, ; //X2_NOMESPA
	'TIPOS DE BEM OCS'														, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	{ 'Código'																, .T. }, ; //X3_TITSPA
	{ 'Código'																, .T. }, ; //X3_TITENG
	{ 'Código do Tipo do Bem'												, .T. }, ; //X3_DESCRIC
	{ 'Código do Tipo do Bem'												, .T. }, ; //X3_DESCSPA
	{ 'Código do Tipo do Bem'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Descrição do Tipo do Bem'											, .T. }, ; //X3_DESCRIC
	{ 'Descrição do Tipo do Bem'											, .T. }, ; //X3_DESCSPA
	{ 'Descrição do Tipo do Bem'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SN1'																	, .T. }, ; //X3_ARQUIVO
	{ '91'																	, .T. }, ; //X3_ORDEM
	{ 'N1_XTPOCS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo do Bem'															, .T. }, ; //X3_TITULO
	{ 'Tipo do Bem'															, .T. }, ; //X3_TITSPA
	{ 'Tipo do Bem'															, .T. }, ; //X3_TITENG
	{ 'Tipo do Bem  OCS'													, .T. }, ; //X3_DESCRIC
	{ 'Tipo do Bem  OCS'													, .T. }, ; //X3_DESCSPA
	{ 'Tipo do Bem  OCS'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	{ 'R'																	, .T. }, ; //X3_CONTEXT
	{ ''																	, .T. }, ; //X3_OBRIGAT
	{ 'Vazio() .Or. ExistCpo("SZ1")'										, .T. }, ; //X3_VLDUSER
	{ ''																	, .T. }, ; //X3_CBOX
	{ ''																	, .T. }, ; //X3_CBOXSPA
	{ ''																	, .T. }, ; //X3_CBOXENG
	{ ''																	, .T. }, ; //X3_PICTVAR
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Tipo do Bem OCS'														, ; //XB_DESCRI
	'Tipo do Bem OCS'														, ; //XB_DESCSPA
	'Tipo do Bem OCS'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZ1'																	} ) //XB_CONTEM
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Código do Tipo do Bem' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ1_CODIGO", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z1_CODIGO" )

aHlpPor := {}
aAdd( aHlpPor, 'Descrição do Tipo do Bem' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ1_DESCRI", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z1_DESCRI" )

//
// Helps Tabela SN1
//
aHlpPor := {}
aAdd( aHlpPor, 'Tipo do Bem  OCS' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PN1_XTPOCS ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "N1_XTPOCS" )

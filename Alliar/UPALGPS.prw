...
/*/
//--------------------------------------------------------------------
User Function UPALGPS( cEmpAmb, cFilAmb )
...
aAdd( aSX6, { ;
	Alltrim(Fwxfilial('SE2'))/*'  '*/																	, ; //X6_FIL
	'ES_GPSFI'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'ID de Gps'														, ; //X6_DESCRIC
	'ID de Gps'														, ; //X6_DSCSPA
	'ID de Gps'														, ; //X6_DSCENG
	'ID de Gps'														, ; //X6_DESC1
	'ID de Gps'														, ; //X6_DSCSPA1
	'ID de Gps'														, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'0'																		, ; //X6_CONTEUD
...
aAdd( aSXB, { ;
	...
	'DB'																	, ; //XB_COLUNA
	'Id de GPS'																, ; //XB_DESCRI
	'Id de GPS'																, ; //XB_DESCSPA
	'Id de GPS'																, ; //XB_DESCENG
	''													, ; //XB_WCONTEM
	'SZM'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_COLUNA
	'Filial+id           '																, ; //XB_DESCRI
	'Filial+id           '																, ; //XB_DESCSPA
	'Filial+id           '																, ; //XB_DESCENG
	''													, ; //XB_WCONTEM
	'IND001SZM'																	} ) //XB_CONTEM

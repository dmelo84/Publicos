...
/*/
//--------------------------------------------------------------------
User Function UPDTURN( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	4																		, ; //X3_DECIMAL
	'Carga Hr Mes'															, ; //X3_TITULO
	'Carga Hr Mes'															, ; //X3_TITSPA
	'Carga Hr Mes'															, ; //X3_TITENG
	'Carga Hr Mes'															, ; //X3_DESCRIC
	'Carga Hr Mes'															, ; //X3_DESCSPA
	'Carga Hr Mes'															, ; //X3_DESCENG

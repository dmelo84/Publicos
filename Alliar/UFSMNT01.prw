...
/*/
//--------------------------------------------------------------------
User Function UFSMNT01( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UFSMNT01" )
				Else
					MsgStop( "Atualização não Realizada.", "UFSMNT01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'ST9'																	, .T. }, ; //X3_ARQUIVO
	{ '99'																	, .T. }, ; //X3_ORDEM
	{ 'T9_XACESS'															, .T. }, ; //X3_CAMPO
	{ 'M'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Acessórios'															, .T. }, ; //X3_TITULO
	{ 'Acessórios'															, .T. }, ; //X3_TITSPA
	{ 'Acessórios'															, .T. }, ; //X3_TITENG
	{ 'Acessórios'															, .T. }, ; //X3_DESCRIC
	{ 'Acessórios'															, .T. }, ; //X3_DESCSPA
	{ 'Acessórios'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 30																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Atividade'															, .T. }, ; //X3_TITULO
	{ 'Atividade'															, .T. }, ; //X3_TITSPA
	{ 'Atividade'															, .T. }, ; //X3_TITENG
	{ 'Atividade'															, .T. }, ; //X3_DESCRIC
	{ 'Atividade'															, .T. }, ; //X3_DESCSPA
	{ 'Atividade'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Técnico'																, .T. }, ; //X3_TITSPA
	{ 'Técnico'																, .T. }, ; //X3_TITENG
	{ 'Nome do Técnico'														, .T. }, ; //X3_DESCRIC
	{ 'Nome do Técnico'														, .T. }, ; //X3_DESCSPA
	{ 'Nome do Técnico'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
//
aHlpPor := {}
aAdd( aHlpPor, '[Específico] Número do Contrato' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PT9_XCONTRA", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "T9_XCONTRA" )

aHlpPor := {}
aAdd( aHlpPor, '[Específico] Descrição de Acessórios' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PT9_XACESS ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "T9_XACESS" )

//
// Helps Tabela STL
//
aHlpPor := {}
aAdd( aHlpPor, '[Específico] Atividade' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PTL_XATIV  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "TL_XATIV" )

aHlpPor := {}
aAdd( aHlpPor, '[Específico] Nome do Técnico' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PTL_XTECN  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "TL_XTECN" )

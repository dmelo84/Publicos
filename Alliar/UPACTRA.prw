...
//--------------------------------------------------------------------
/*/{Protheus.doc} UPACTRA
Função de update de dicionários para compatibilização
Acrescentar campo semelhante ao TNC_DISTAC (entretanto do tipo "C" apenas 
...
/*/
//--------------------------------------------------------------------
User Function UPACTRA( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	'Dist(Alfa)'																, ; //X3_TITSPA
	'Dist(Alfa)'																, ; //X3_TITENG
	'Dist(Alfa)'														, ; //X3_DESCRIC
	'Dist(Alfa)'														, ; //X3_DESCSPA
	'Dist(Alfa)'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID

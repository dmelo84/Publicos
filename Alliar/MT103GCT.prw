...
/*/{Protheus.doc} MT103GCT
Este ponto de entrada tem o objetivo de incluir os 
itens não-pertinentes ao Módulo  Gestão de Contratos no 
Documento de Entrada ou, não, durante a sua validação. 
@author Jonatas Oliveira | www.compila.com.br
@since 15/03/2019
@version 1.0
/*/
User Function MT103GCT()

...
/*/
//--------------------------------------------------------------------
User Function UFSCTB01( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UFSCTB01" )
				Else
					MsgStop( "Atualização não Realizada.", "UFSCTB01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'CONTABILIZACAO DIGITALMED'												, ; //X2_NOME
	'CONTABILIZACAO DIGITALMED'												, ; //X2_NOMESPA
	'CONTABILIZACAO DIGITALMED'												, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	{ 'SZ4'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'Z4_ANOMES'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Ref.Ano Mes'															, .T. }, ; //X3_TITULO
	{ 'Ref.Ano Mes'															, .T. }, ; //X3_TITSPA
	{ 'Ref.Ano Mes'															, .T. }, ; //X3_TITENG
	{ 'Referencia Ano Mes'													, .T. }, ; //X3_DESCRIC
	{ 'Referencia Ano Mes'													, .T. }, ; //X3_DESCSPA
	{ 'Referencia Ano Mes'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Val.Producao'														, .T. }, ; //X3_TITULO
	{ 'Val.Producao'														, .T. }, ; //X3_TITSPA
	{ 'Val.Producao'														, .T. }, ; //X3_TITENG
	{ 'Valor Producao'														, .T. }, ; //X3_DESCRIC
	{ 'Valor Producao'														, .T. }, ; //X3_DESCSPA
	{ 'Valor Producao'														, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	{ 'SZ4'																	, .T. }, ; //X3_ARQUIVO
	{ '04'																	, .T. }, ; //X3_ORDEM
	{ 'Z4_RECFAT'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Rec. Faturar'														, .T. }, ; //X3_TITULO
	{ 'Rec. Faturar'														, .T. }, ; //X3_TITSPA
	{ 'Rec. Faturar'														, .T. }, ; //X3_TITENG
	{ 'Receita Faturada'													, .T. }, ; //X3_DESCRIC
	{ 'Receita Faturada'													, .T. }, ; //X3_DESCSPA
	{ 'Receita Faturada'													, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZ4'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'Z4_RECAFAT'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Rec. a Fatur'														, .T. }, ; //X3_TITULO
	{ 'Rec. a Fatur'														, .T. }, ; //X3_TITSPA
	{ 'Rec. a Fatur'														, .T. }, ; //X3_TITENG
	{ 'Receita a Faturar'													, .T. }, ; //X3_DESCRIC
	{ 'Receita a Faturar'													, .T. }, ; //X3_DESCSPA
	{ 'Receita a Faturar'													, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Diferenca'															, .T. }, ; //X3_TITULO
	{ 'Diferenca'															, .T. }, ; //X3_TITSPA
	{ 'Diferenca'															, .T. }, ; //X3_TITENG
	{ 'Diferenca'															, .T. }, ; //X3_DESCRIC
	{ 'Diferenca'															, .T. }, ; //X3_DESCSPA
	{ 'Diferenca'															, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Val.Perda'															, .T. }, ; //X3_TITULO
	{ 'Val.Perda'															, .T. }, ; //X3_TITSPA
	{ 'Val.Perda'															, .T. }, ; //X3_TITENG
	{ 'Valor Perda'															, .T. }, ; //X3_DESCRIC
	{ 'Valor Perda'															, .T. }, ; //X3_DESCSPA
	{ 'Valor Perda'															, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Num Lote Ctb'														, .T. }, ; //X3_TITULO
	{ 'Num Lote Ctb'														, .T. }, ; //X3_TITSPA
	{ 'Num Lote Ctb'														, .T. }, ; //X3_TITENG
	{ 'Numero Lote Contabil'												, .T. }, ; //X3_DESCRIC
	{ 'Numero Lote Contabil'												, .T. }, ; //X3_DESCSPA
	{ 'Numero Lote Contabil'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Apurado'																, .T. }, ; //X3_TITSPA
	{ 'Apurado'																, .T. }, ; //X3_TITENG
	{ 'Apurado'																, .T. }, ; //X3_DESCRIC
	{ 'Apurado'																, .T. }, ; //X3_DESCSPA
	{ 'Apurado'																, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Flag Contab'															, .T. }, ; //X3_TITULO
	{ 'Flag Contab'															, .T. }, ; //X3_TITSPA
	{ 'Flag Contab'															, .T. }, ; //X3_TITENG
	{ 'Flag Contabilizacao'													, .T. }, ; //X3_DESCRIC
	{ 'Flag Contabilizacao'													, .T. }, ; //X3_DESCSPA
	{ 'Flag Contabilizacao'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZ4'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'Z4_FILIAL+Z4_ANOMES'													, ; //CHAVE
	'Ref.Ano Mes'															, ; //DESCRICAO
	'Ref.Ano Mes'															, ; //DESCSPA
	'Ref.Ano Mes'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSX6, { ;
	...
	'ES_CTBPD1'																, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Lancamento Padrao para'												, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'contabilizacao de Producao'											, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	'Valor Apurado > Produzido'												, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'100'																	, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
...
aAdd( aSX6, { ;
	...
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'contabilizacao Perdas'													, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
...
PutHelp( "PZ4_FILIAL ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_FILIAL" )

aHlpPor := {}
aAdd( aHlpPor, 'Ano Mes de Referencia' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_ANOMES ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_ANOMES" )

aHlpPor := {}
aAdd( aHlpPor, 'Valor de produção acumulado do ano/mes' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_VALOR  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_VALOR" )

aHlpPor := {}
aAdd( aHlpPor, 'Receita Faturada' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_RECFAT ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_RECFAT" )

aHlpPor := {}
aAdd( aHlpPor, 'Receita a Faturar' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_RECAFAT", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_RECAFAT" )

aHlpPor := {}
aAdd( aHlpPor, 'Valor após apuração' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_DIFER  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_DIFER" )

aHlpPor := {}
aAdd( aHlpPor, 'Valor de perda acumulado do ano' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_PERDA  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_PERDA" )

aHlpPor := {}
aAdd( aHlpPor, 'Numero do Lote Contabil' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_LOTE   ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_LOTE" )

aHlpPor := {}
aAdd( aHlpPor, 'Apurado (S/N)' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_APUR   ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_APUR" )

aHlpPor := {}
aAdd( aHlpPor, 'Falg de contabilização (S/N)' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_LA     ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_LA" )

aHlpPor := {}
aAdd( aHlpPor, 'Campo de marca para markbrowse' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ4_OK     ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z4_OK" )

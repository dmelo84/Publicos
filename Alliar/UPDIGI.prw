...
/*/
//--------------------------------------------------------------------
User Function UPDIGI( cEmpAmb, cFilAmb )
...
aAdd( aSX3, { ;
	...
	13																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pgto Dig.Med'																, ; //X3_TITULO
	'Pgto Dig.Med'																, ; //X3_TITSPA
	'Pgto Dig.Med'																, ; //X3_TITENG
	'Pgto Dig.Med'														, ; //X3_DESCRIC
	'Pgto Dig.Med'														, ; //X3_DESCSPA
	'Pgto Dig.Med'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	30																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'ID Dig.Med'																, ; //X3_TITULO
	'ID Dig.Med'																, ; //X3_TITSPA
	'ID Dig.Med'																, ; //X3_TITENG
	'ID Dig.Med'														, ; //X3_DESCRIC
	'ID Dig.Med'														, ; //X3_DESCSPA
	'ID Dig.Med'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;

		...
		While !(cAliasSD2)->(Eof()) .And. xFilial("SD2") == (cAliasSD2)->D2_FILIAL .And.;
			...
			If dbSeek(xFilial("SX5")+"60"+RetFldProd(SB1->B1_COD,"B1_CODISS"))
				If !lNFeDesc  .And. nCont == 1
					If  cCodmun == "3300704-3156700"
						cNatOper := If(FindFunction('CleanSpecChar'),CleanSpecChar(AllTrim(SubStr(SX5->(FIELDGET(FIELDPOS("X5_DESCRI"))),1,55))),AllTrim(SubStr(SX5->(FIELDGET(FIELDPOS("X5_DESCRI"))),1,55))) + cNatOper
	    			Else
	    	    ...
	    	    ElseIf nCont == 1 
	    	        If cCodmun == "3300704-3156700"
						cDescrNFSe := If(FindFunction('CleanSpecChar'),CleanSpecChar(AllTrim(SubStr(SX5->(FIELDGET(FIELDPOS("X5_DESCRI"))),1,55))),AllTrim(SubStr(SX5->(FIELDGET(FIELDPOS("X5_DESCRI"))),1,55))) + cNatOper
	    			Else

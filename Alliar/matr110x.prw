...
/*/
Static Function Matr110x( cAlias, nReg, nOpcx )
...
If FunName() == Alltrim("MATR111") .Or. (cPaisLoc <> "BRA" .And. FunName() == Alltrim("MATA121"))
	lTRepInUse := .T.
Else                                    
	lTRepInUse := TRepInUse()//pergunta se usa relatorio personalisavel sim ou nao 
EndIf
	...
	//Incluida validação para os pedidos de compras por item do pedido  (IP/alçada)			
		...
		If !lNewAlc
			...
			If SC7->C7_TIPO == 1 .OR. SC7->C7_TIPO == 3
				...
				//sivaldo chamada para inclusão do termo de aceite 06/04/2017
				oReport:EndPage()
				oReport:StartPage()
				
				oReport:PrintText(STRTERMO1,,900 ) 
				...
				oReport:PrintText(STRTERMO2,,050 )
				oReport:PrintText(STRTERMO3,,050 )
				oReport:PrintText(STRTERMO4,,050 )
				oReport:PrintText(STRTERMO5,,050 )
				oReport:PrintText(STRTERMO6,,050 )
				oReport:PrintText(STRTERMO7,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO8,,050 )
				oReport:PrintText(STRTERMO9,,050 )
				oReport:PrintText(STRTERMO10,,050 )
				oReport:PrintText(STRTERMO11,,050 )
				oReport:PrintText(STRTERMO12,,050 )
				oReport:PrintText(STRTERMO13,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO14,,050 )
				oReport:PrintText(STRTERMO15,,050 )
				oReport:PrintText(STRTERMO16,,050 )
				oReport:PrintText(STRTERMO17,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO18,,050 )
				oReport:PrintText(STRTERMO19,,050 )
				oReport:PrintText(STRTERMO20,,050 )
				oReport:PrintText(STRTERMO21,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO22,,050 )
				oReport:PrintText(STRTERMO23,,050 )
				oReport:PrintText(STRTERMO24,,050 )
				oReport:PrintText(STRTERMO25,,050 )
				oReport:PrintText(STRTERMO26,,050 )
				oReport:PrintText(STRTERMO27,,050 )
				oReport:PrintText(STRTERMO28,,050 )
				oReport:PrintText(STRTERMO29,,050 )
				oReport:PrintText(STRTERMO30,,050 )
				oReport:PrintText(STRTERMO31,,050 )
				oReport:PrintText(STRTERMO32,,050 )
				oReport:PrintText(STRTERMO33,,050 )
				oReport:PrintText(STRTERMO34,,050 )
				oReport:PrintText(STRTERMO35,,050 )
				oReport:PrintText(STRTERMO36,,050 )
				oReport:PrintText(STRTERMO37,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO38,,050 )
				oReport:PrintText(STRTERMO39,,050 )
				oReport:PrintText(STRTERMO40,,050 )
				oReport:PrintText(STRTERMO41,,050 )
				oReport:PrintText(STRTERMO42,,050 )
				oReport:PrintText(STRTERMO43,,050 )
				oReport:PrintText(STRTERMO44,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO45,,050 )
				oReport:PrintText(STRTERMO46,,050 )
				oReport:PrintText(STRTERMO47,,050 )
				oReport:PrintText(STRTERMO48,,050 )
				oReport:PrintText(STRTERMO49,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO50,,050 )
				oReport:PrintText(STRTERMO51,,050 )
				oReport:PrintText(STRTERMO52,,050 )
				oReport:PrintText(STRTERMO53,,050 )
				oReport:PrintText(STRTERMO54,,050 )
				oReport:PrintText(STRTERMO55,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO56,,050 )
				oReport:PrintText(STRTERMO57,,050 )
				oReport:PrintText(STRTERMO58,,050 )
				oReport:PrintText(STRTERMO59,,050 )
				oReport:PrintText(STRTERMO60,,050 )
				oReport:PrintText(STRTERMO61,,050 )
				oReport:PrintText(STRTERMO62,,050 )
				oReport:PrintText(STRTERMO63,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO64,,050 )
				oReport:PrintText(STRTERMO65,,050 )
				oReport:PrintText(STRTERMO66,,050 )
				oReport:PrintText(STRTERMO67,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO68,,050 )
				oReport:PrintText(STRTERMO69,,050 )
				oReport:PrintText(STRTERMO70,,050 )
				oReport:PrintText(STRTERMO71,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO72,,050 )
				oReport:PrintText(STRTERMO73,,050 )
				oReport:PrintText(STRTERMO74,,050 )
				oReport:PrintText(STRTERMO75,,050 )
				oReport:PrintText(STRTERMO76,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO77,,050 )
				oReport:PrintText(STRTERMO78,,050 )
				oReport:PrintText(STRTERMO79,,050 )
				oReport:PrintText(STRTERMO80,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO81,,050 )
				oReport:PrintText(STRTERMO82,,050 )
				oReport:PrintText(STRTERMO83,,050 )
				oReport:PrintText(STRTERMO84,,050 )
				oReport:PrintText(STRTERMO85,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO86,,050 )
				oReport:PrintText(STRTERMO87,,050 )
				oReport:PrintText(STRTERMO88,,050 )
				oReport:PrintText(STRTERMO89,,050 )
				oReport:PrintText(STRTERMO90,,050 )
				oReport:PrintText(STRTERMO91,,050 )
				oReport:PrintText(STRTERMO92,,050 )
				oReport:PrintText(STRTERMO93,,050 )
				oReport:PrintText(STRTERMO94,,050 )
				oReport:PrintText(STRTERMO95,,050 )
				oReport:PrintText(STRTERMO96,,050 )
				oReport:PrintText(STRTERMO97,,050 )
				oReport:PrintText(STRTERMO98,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO99,,050 )
				oReport:PrintText(STRTERMO100,,050 )
				oReport:PrintText(STRTERMO101,,050 )
				oReport:PrintText(STRTERMO102,,050 )
				oReport:PrintText(STRTERMO103,,050 )
				oReport:PrintText(STRTERMO104,,050 )
				oReport:PrintText(STRTERMO105,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO106,,050 )
				oReport:PrintText(STRTERMO107,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO108,,050 )
				oReport:PrintText(STRTERMO109,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO110,,050 )
				oReport:PrintText(STRTERMO111,,050 )
				oReport:PrintText(STRTERMO112,,050 )
				oReport:PrintText(STRTERMO113,,050 )
				oReport:PrintText(STRTERMO114,,050 )
				oReport:SkipLine()
				oReport:PrintText(STRTERMO115,,050 )
				oReport:PrintText(STRTERMO116,,050 )
				oReport:PrintText(STRTERMO117,,050 )
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡…o    ³ MATRx110R3³ Autor ³ Wagner Xavier         ³ Data ³ 05.09.91 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
±±³Descri‡ao ³ PLANO DE MELHORIA CONTINUA        ³Programa: MATRx110R3.PRX ³±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
Static Function MATRx110R3(cAlias,nReg,nOpcx)
...
dbSetOrder(2)
If dbSeek("C7_CC")
	If SX3->(FIELDGET(FIELDPOS("X3_TAMANHO"))) == 9
		nDifColCC := 11
		Tamanho   := "M"
	Else
...
EndIf
    ...
    //  @ li,001 PSAY STR0024  //"|   NOTA: So aceitaremos a mercadoria se na sua Nota Fiscal constar o numero do nosso Pedido de Compras."
		...
		@  li++,050  PSAY    STRTERMO1 
		li:= 5
		@  li++,010  PSAY    STRTERMO2 
		@  li++,013  PSAY    STRTERMO3
		@  li++,013  PSAY    STRTERMO4
		@  li++,013  PSAY    STRTERMO5
		@  li++,013  PSAY    STRTERMO6
		@  li++,013  PSAY    STRTERMO7
		@  li++,013  PSAY    STRTERMO8
		@  li++,013  PSAY    STRTERMO9
		@  li++,013  PSAY    STRTERMO10
		@  li++,013  PSAY    STRTERMO11
		@  li++,010  PSAY    STRTERMO12
		@  li++,013  PSAY    STRTERMO13
		@  li++,013  PSAY    STRTERMO14
		@  li++,013  PSAY    STRTERMO15
		@  li++,013  PSAY    STRTERMO16
		@  li++,013  PSAY    STRTERMO17
		@  li++,013  PSAY    STRTERMO18
		@  li++,013  PSAY    STRTERMO19
		@  li++,013  PSAY    STRTERMO20
		@  li++,010  PSAY    STRTERMO21
		@  li++,013  PSAY    STRTERMO22
		@  li++,013  PSAY    STRTERMO23
		@  li++,013  PSAY    STRTERMO24
		@  li++,013  PSAY    STRTERMO25
		@  li++,010  PSAY    STRTERMO26
		@  li++,013  PSAY    STRTERMO27
		@  li++,013  PSAY    STRTERMO28
		@  li++,013  PSAY    STRTERMO29
		@  li++,013  PSAY    STRTERMO30
		@  li++,010  PSAY    STRTERMO31
		@  li++,013  PSAY    STRTERMO32
		@  li++,013  PSAY    STRTERMO33
		@  li++,013  PSAY    STRTERMO34
		@  li++,013  PSAY    STRTERMO35
		@  li++,013  PSAY    STRTERMO36
		@  li++,013  PSAY    STRTERMO37
		@  li++,013  PSAY    STRTERMO38
		@  li++,013  PSAY    STRTERMO39
		@  li++,013  PSAY    STRTERMO40
		@  li++,013  PSAY    STRTERMO41
		@  li++,013  PSAY    STRTERMO42
		@  li++,013  PSAY    STRTERMO43
		@  li++,013  PSAY    STRTERMO44
		@  li++,013  PSAY    STRTERMO45
		@  li++,013  PSAY    STRTERMO46
		@  li++,013  PSAY    STRTERMO47
		@  li++,013  PSAY    STRTERMO48
		@  li++,013  PSAY    STRTERMO49
		@  li++,013  PSAY    STRTERMO50
		@  li++,013  PSAY    STRTERMO51
		@  li++,013  PSAY    STRTERMO52
		@  li++,010  PSAY    STRTERMO53
		@  li++,013  PSAY    STRTERMO54
		@  li++,013  PSAY    STRTERMO55
		@  li++,013  PSAY    STRTERMO56
		@  li++,013  PSAY    STRTERMO57
		@  li++,013  PSAY    STRTERMO58
		@  li++,013  PSAY    STRTERMO59
		@  li++,013  PSAY    STRTERMO60
		@  li++,013  PSAY    STRTERMO61
		@  li++,013  PSAY    STRTERMO62
		@  li++,010  PSAY    STRTERMO63
		@  li++,013  PSAY    STRTERMO64
		@  li++,013  PSAY    STRTERMO65
		@  li++,013  PSAY    STRTERMO66
		@  li++,013  PSAY    STRTERMO67
		@  li++,013  PSAY    STRTERMO68
		@  li++,013  PSAY    STRTERMO69 
		@  li++,013  PSAY    STRTERMO70
		@  li++,013  PSAY    STRTERMO71
		@  li++,013  PSAY    STRTERMO72
		 If li<>1
		   li := 1
		 EndIf
		@  li++,010  PSAY    STRTERMO73
		@  li++,013  PSAY    STRTERMO74
		@  li++,013  PSAY    STRTERMO75
		@  li++,013  PSAY    STRTERMO76
		@  li++,013  PSAY    STRTERMO77
		@  li++,013  PSAY    STRTERMO78
		@  li++,010  PSAY    STRTERMO79
		@  li++,013  PSAY    STRTERMO80
		@  li++,013  PSAY    STRTERMO81
		@  li++,013  PSAY    STRTERMO82
		@  li++,013  PSAY    STRTERMO83
		@  li++,013  PSAY    STRTERMO84
		@  li++,013  PSAY    STRTERMO85
		@  li++,013  PSAY    STRTERMO86
		@  li++,013  PSAY    STRTERMO87
		@  li++,013  PSAY    STRTERMO88
		@  li++,010  PSAY    STRTERMO89
		@  li++,013  PSAY    STRTERMO90
		@  li++,013  PSAY    STRTERMO91
		@  li++,013  PSAY    STRTERMO92
		@  li++,013  PSAY    STRTERMO93
		@  li++,010  PSAY    STRTERMO94
		@  li++,013  PSAY    STRTERMO95
		@  li++,013  PSAY    STRTERMO96
		@  li++,013  PSAY    STRTERMO97
		@  li++,013  PSAY    STRTERMO98
		@  li++,013  PSAY    STRTERMO99
		@  li++,013  PSAY    STRTERMO100
		@  li++,010  PSAY    STRTERMO101
		@  li++,013  PSAY    STRTERMO102
		@  li++,013  PSAY    STRTERMO103
		@  li++,013  PSAY    STRTERMO104
		@  li++,013  PSAY    STRTERMO105
		@  li++,013  PSAY    STRTERMO106
		@  li++,013  PSAY    STRTERMO107
		@  li++,013  PSAY    STRTERMO108
		@  li++,010  PSAY    STRTERMO109
		@  li++,013  PSAY    STRTERMO110
		@  li++,013  PSAY    STRTERMO111
		@  li++,013  PSAY    STRTERMO112
		@  li++,013  PSAY    STRTERMO113
		@  li++,010  PSAY    STRTERMO114
		@  li++,013  PSAY    STRTERMO115
		@  li++,013  PSAY    STRTERMO116
		@  li++,013  PSAY    STRTERMO117
		@  li++,013  PSAY    STRTERMO118
		@  li++,013  PSAY    STRTERMO119
		@  li++,013  PSAY    STRTERMO120
		@  li++,013  PSAY    STRTERMO121
		@  li++,010  PSAY    STRTERMO122
		@  li++,013  PSAY    STRTERMO123
		@  li++,013  PSAY    STRTERMO124
		@  li++,013  PSAY    STRTERMO125
		@  li++,013  PSAY    STRTERMO126
		@  li++,013  PSAY    STRTERMO127
		@  li++,013  PSAY    STRTERMO128
		@  li++,013  PSAY    STRTERMO129
		@  li++,013  PSAY    STRTERMO130
		@  li++,013  PSAY    STRTERMO131
		@  li++,013  PSAY    STRTERMO132
		@  li++,013  PSAY    STRTERMO133
		@  li++,013  PSAY    STRTERMO134
		@  li++,013  PSAY    STRTERMO135
		@  li++,013  PSAY    STRTERMO136
		@  li++,013  PSAY    STRTERMO137
		@  li++,013  PSAY    STRTERMO138
		@  li++,013  PSAY    STRTERMO139
		@  li++,013  PSAY    STRTERMO140
		@  li++,013  PSAY    STRTERMO141
		@  li++,010  PSAY    STRTERMO142
		@  li++,013  PSAY    STRTERMO143
		@  li++,013  PSAY    STRTERMO144
		...
		@  li++,013  PSAY    STRTERMO145
		@  li++,013  PSAY    STRTERMO146
		@  li++,013  PSAY    STRTERMO147
		@  li++,013  PSAY    STRTERMO148
		@  li++,013  PSAY    STRTERMO149
		@  li++,013  PSAY    STRTERMO150
		@  li++,013  PSAY    STRTERMO151
		@  li++,013  PSAY    STRTERMO152
		@  li++,010  PSAY    STRTERMO153
		@  li++,013  PSAY    STRTERMO154
		@  li++,013  PSAY    STRTERMO155
		@  li++,010  PSAY    STRTERMO156
		@  li++,013  PSAY    STRTERMO157
		@  li++,013  PSAY    STRTERMO158
		@  li++,010  PSAY    STRTERMO159
		@  li++,013  PSAY    STRTERMO160
		@  li++,013  PSAY    STRTERMO161
		@  li++,013  PSAY    STRTERMO162
		@  li++,013  PSAY    STRTERMO163
		@  li++,013  PSAY    STRTERMO164
		@  li++,013  PSAY    STRTERMO165
		@  li++,013  PSAY    STRTERMO166
		@  li++,010  PSAY    STRTERMO167
		@  li++,013  PSAY    STRTERMO168
		@  li++,013  PSAY    STRTERMO169
		@  li++,013  PSAY    STRTERMO170
		@  li++,013  PSAY    STRTERMO171
...
Local nX3VALID	 :=	SX3->(FIELDPOS("X3_VALID"))
...
If dbSeek(xFilial("SC7")+cPedido+cItemDe+Alltrim(cSequen))
	...
	While !Eof() .AND. SC7->C7_FILIAL+SC7->C7_NUM == xFilial("SC7")+cPedido .AND. ;
		...
		dbSetOrder(1)
		dbSeek('SC7')
		While !EOF() .AND. ((FIELDGET(nX3ARQUIVO)) == 'SC7')
			cValid	:= StrTran(UPPER(SX3->(FIELDGET(nX3VALID)))," ","")
			cValid	:= StrTran(cValid,"'",'"')
			If "MAFISREF" $ cValid
				nPosRef  := AT('MAFISREF("',cValid) + 10
				cRefCols := Substr(cValid,nPosRef,AT('","MT120",',cValid)-nPosRef )
				// Carrega os valores direto do SC7.           
				MaFisLoad(cRefCols,&("SC7->"+ SX3->(FIELDGET(nX3CAMPO))),nItem)
			EndIf
			dbSkip()
		End

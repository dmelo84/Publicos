...
/* ===============================================================================
WSDL Location    http://alliardev.fluig.com/webdesk/ECMWorkflowEngineService?wsdl
Gerado em        02/29/16 14:35:53
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _NCMMSZK ; Return  // "dummy" function - Internal Use 
...
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += "</q1:createWorkFlowProcessVersion>"

oXmlRet := SvcSoapCall(	Self,cSoap,; 
	"createWorkFlowProcessVersion",; 
	"RPCX","http://ws.workflow.ecm.technology.totvs.com/",,,; 
	"http://alliardev.fluig.com/webdesk/ECMWorkflowEngineService")
...
cSoap += WSSoapValue("password", ::cpassword, cpassword , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("stateSequence", ::nstateSequence, nstateSequence , "int", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("hora", ::nhora, nhora , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("prazo", ::nprazo, nprazo , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("periodId", ::cperiodId, cperiodId , "string", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cancelText", ::ccancelText, ccancelText , "string", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processAttachs", ::oWSimportProcessWithCardprocessAttachs, oWSimportProcessWithCardprocessAttachs , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("newProcess", ::lnewProcess, lnewProcess , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("overWrite", ::loverWrite, loverWrite , "boolean", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("cardDescription", ::ccardDescription, ccardDescription , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("datasetName", ::cdatasetName, cdatasetName , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardAttachs", ::oWSimportProcessWithCardcardAttachs, oWSimportProcessWithCardcardAttachs , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("customEvents", ::oWSimportProcessWithCardcustomEvents, oWSimportProcessWithCardcustomEvents , "cardEventDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("update", ::lupdate, lupdate , "boolean", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("threadSequence", ::nthreadSequence, nthreadSequence , "int", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("comments", ::ccomments, ccomments , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("attachments", ::oWSsimpleStartProcessattachments, oWSsimpleStartProcessattachments , "processAttachmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardData", ::oWSsimpleStartProcesscardData, oWSsimpleStartProcesscardData , "stringArrayArray", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardFieldName", ::ccardFieldName, ccardFieldName , "string", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("choosedState", ::nchoosedState, nchoosedState , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueIds", ::oWSsaveAndSendTaskcolleagueIds, oWSsaveAndSendTaskcolleagueIds , "stringArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("comments", ::ccomments, ccomments , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("completeTask", ::lcompleteTask, lcompleteTask , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("attachments", ::oWSsaveAndSendTaskattachments, oWSsaveAndSendTaskattachments , "processAttachmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardData", ::oWSsaveAndSendTaskcardData, oWSsaveAndSendTaskcardData , "stringArrayArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("appointment", ::oWSsaveAndSendTaskappointment, oWSsaveAndSendTaskappointment , "processTaskAppointmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("managerMode", ::lmanagerMode, lmanagerMode , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("threadSequence", ::nthreadSequence, nthreadSequence , "int", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("document", ::oWSupdateWorkflowAttachmentdocument, oWSupdateWorkflowAttachmentdocument , "documentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("attachments", ::oWSupdateWorkflowAttachmentattachments, oWSupdateWorkflowAttachmentattachments , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("threadSequence", ::nthreadSequence, nthreadSequence , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("newDueDate", ::cnewDueDate, cnewDueDate , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("timeInSecods", ::ntimeInSecods, ntimeInSecods , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += "</q1:setDueDate>"
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processAttachs", ::oWSimportProcessWithCardAndRelatedDatasetsprocessAttachs, oWSimportProcessWithCardAndRelatedDatasetsprocessAttachs , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("newProcess", ::lnewProcess, lnewProcess , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("overWrite", ::loverWrite, loverWrite , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueId", ::ccolleagueId, ccolleagueId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("parentDocumentId", ::nparentDocumentId, nparentDocumentId , "int", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("cardDescription", ::ccardDescription, ccardDescription , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("datasetName", ::cdatasetName, cdatasetName , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardAttachs", ::oWSimportProcessWithCardAndRelatedDatasetscardAttachs, oWSimportProcessWithCardAndRelatedDatasetscardAttachs , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("customEvents", ::oWSimportProcessWithCardAndRelatedDatasetscustomEvents, oWSimportProcessWithCardAndRelatedDatasetscustomEvents , "cardEventDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("generalInfo", ::oWSimportProcessWithCardAndRelatedDatasetsgeneralInfo, oWSimportProcessWithCardAndRelatedDatasetsgeneralInfo , "generalInfoDto", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("update", ::lupdate, lupdate , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("persistenceType", ::npersistenceType, npersistenceType , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("relatedDatasets", ::oWSimportProcessWithCardAndRelatedDatasetsrelatedDatasets, oWSimportProcessWithCardAndRelatedDatasetsrelatedDatasets , "stringArray", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueId", ::ccolleagueId, ccolleagueId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("content", ::ccontent, ccontent , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("favorite", ::lfavorite, lfavorite , "boolean", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processAttachs", ::oWSimportProcessWithCardAndGeneralInfoprocessAttachs, oWSimportProcessWithCardAndGeneralInfoprocessAttachs , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("newProcess", ::lnewProcess, lnewProcess , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("overWrite", ::loverWrite, loverWrite , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueId", ::ccolleagueId, ccolleagueId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("parentDocumentId", ::nparentDocumentId, nparentDocumentId , "int", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("cardDescription", ::ccardDescription, ccardDescription , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("datasetName", ::cdatasetName, cdatasetName , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardAttachs", ::oWSimportProcessWithCardAndGeneralInfocardAttachs, oWSimportProcessWithCardAndGeneralInfocardAttachs , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("customEvents", ::oWSimportProcessWithCardAndGeneralInfocustomEvents, oWSimportProcessWithCardAndGeneralInfocustomEvents , "cardEventDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("generalInfo", ::oWSimportProcessWithCardAndGeneralInfogeneralInfo, oWSimportProcessWithCardAndGeneralInfogeneralInfo , "generalInfoDto", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("update", ::lupdate, lupdate , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("persistenceType", ::npersistenceType, npersistenceType , "int", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("attachments", ::oWSimportProcessattachments, oWSimportProcessattachments , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("newProcess", ::lnewProcess, lnewProcess , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("overWrite", ::loverWrite, loverWrite , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueId", ::ccolleagueId, ccolleagueId , "string", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("state", ::nstate, nstate , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("threadSequence", ::nthreadSequence, nthreadSequence , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("limit", ::nlimit, nlimit , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("initialUser", ::ninitialUser, ninitialUser , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("userSearch", ::cuserSearch, cuserSearch , "string", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processAttachs", ::oWSimportProcessWithCardAndPersistenceTypeprocessAttachs, oWSimportProcessWithCardAndPersistenceTypeprocessAttachs , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("newProcess", ::lnewProcess, lnewProcess , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("overWrite", ::loverWrite, loverWrite , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueId", ::ccolleagueId, ccolleagueId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("parentDocumentId", ::nparentDocumentId, nparentDocumentId , "int", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("cardDescription", ::ccardDescription, ccardDescription , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("datasetName", ::cdatasetName, cdatasetName , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardAttachs", ::oWSimportProcessWithCardAndPersistenceTypecardAttachs, oWSimportProcessWithCardAndPersistenceTypecardAttachs , "attachmentArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("customEvents", ::oWSimportProcessWithCardAndPersistenceTypecustomEvents, oWSimportProcessWithCardAndPersistenceTypecustomEvents , "cardEventDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("update", ::lupdate, lupdate , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("persistenceType", ::npersistenceType, npersistenceType , "int", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("choosedState", ::nchoosedState, nchoosedState , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueIds", ::oWSstartProcessClassiccolleagueIds, oWSstartProcessClassiccolleagueIds , "stringArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("comments", ::ccomments, ccomments , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("completeTask", ::lcompleteTask, lcompleteTask , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("attachments", ::oWSstartProcessClassicattachments, oWSstartProcessClassicattachments , "processAttachmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardData", ::oWSstartProcessClassiccardData, oWSstartProcessClassiccardData , "keyValueDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("appointment", ::oWSstartProcessClassicappointment, oWSstartProcessClassicappointment , "processTaskAppointmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("managerMode", ::lmanagerMode, lmanagerMode , "boolean", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("processId", ::cprocessId, cprocessId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("choosedState", ::nchoosedState, nchoosedState , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueIds", ::oWSstartProcesscolleagueIds, oWSstartProcesscolleagueIds , "stringArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("comments", ::ccomments, ccomments , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("completeTask", ::lcompleteTask, lcompleteTask , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("attachments", ::oWSstartProcessattachments, oWSstartProcessattachments , "processAttachmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardData", ::oWSstartProcesscardData, oWSstartProcesscardData , "stringArrayArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("appointment", ::oWSstartProcessappointment, oWSstartProcessappointment , "processTaskAppointmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("managerMode", ::lmanagerMode, lmanagerMode , "boolean", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("choosedState", ::nchoosedState, nchoosedState , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueIds", ::oWSsaveAndSendTaskClassiccolleagueIds, oWSsaveAndSendTaskClassiccolleagueIds , "stringArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("comments", ::ccomments, ccomments , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("completeTask", ::lcompleteTask, lcompleteTask , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("attachments", ::oWSsaveAndSendTaskClassicattachments, oWSsaveAndSendTaskClassicattachments , "processAttachmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardData", ::oWSsaveAndSendTaskClassiccardData, oWSsaveAndSendTaskClassiccardData , "keyValueDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("appointment", ::oWSsaveAndSendTaskClassicappointment, oWSsaveAndSendTaskClassicappointment , "processTaskAppointmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("managerMode", ::lmanagerMode, lmanagerMode , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("threadSequence", ::nthreadSequence, nthreadSequence , "int", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("choosedState", ::nchoosedState, nchoosedState , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueIds", ::oWSsaveAndSendTaskByReplacementcolleagueIds, oWSsaveAndSendTaskByReplacementcolleagueIds , "stringArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("comments", ::ccomments, ccomments , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("completeTask", ::lcompleteTask, lcompleteTask , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("attachments", ::oWSsaveAndSendTaskByReplacementattachments, oWSsaveAndSendTaskByReplacementattachments , "processAttachmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("cardData", ::oWSsaveAndSendTaskByReplacementcardData, oWSsaveAndSendTaskByReplacementcardData , "stringArrayArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("appointment", ::oWSsaveAndSendTaskByReplacementappointment, oWSsaveAndSendTaskByReplacementappointment , "processTaskAppointmentDtoArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("managerMode", ::lmanagerMode, lmanagerMode , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("threadSequence", ::nthreadSequence, nthreadSequence , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("replacementId", ::creplacementId, creplacementId , "string", .T. , .T. , 0 , NIL, .F.) 
...
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("iTaskAutom", ::niTaskAutom, niTaskAutom , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("iTask", ::niTask, niTask , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("condition", ::ncondition, ncondition , "int", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("colleagueIds", ::oWSsetAutomaticDecisionClassiccolleagueIds, oWSsetAutomaticDecisionClassiccolleagueIds , "stringArray", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("comments", ::ccomments, ccomments , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("userId", ::cuserId, cuserId , "string", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("managerMode", ::lmanagerMode, lmanagerMode , "boolean", .T. , .T. , 0 , NIL, .F.) 
cSoap += WSSoapValue("threadSequence", ::nthreadSequence, nthreadSequence , "int", .T. , .T. , 0 , NIL, .F.) 
...
WSMETHOD SOAPRECV WSSEND oResponse WSCLIENT ECMWorkflowEngineServiceService_processDefinitionVersionDto
	Local oNode7
	Local oNodes11 :=  WSAdvValue( oResponse,"_RELATEDDATASETS","string",{},NIL,.T.,"S",NIL,"xs") 
	::Init()
	If oResponse = NIL ; Return ; Endif 
	...
	oNode7 :=  WSAdvValue( oResponse,"_INITIALPROCESSSTATE","processStateDto",NIL,NIL,NIL,"O",NIL,"xs") 
	If oNode7 != NIL
		::oWSinitialProcessState := ECMWorkflowEngineServiceService_processStateDto():New()
		::oWSinitialProcessState:SoapRecv(oNode7)
	EndIf
	...
	aEval(oNodes11 , { |x| aadd(::crelatedDatasets ,  x:TEXT  ) } )
...
WSMETHOD SOAPSEND WSCLIENT ECMWorkflowEngineServiceService_cardEventDtoArray
	Local cSoap := ""
	aEval( ::oWSitem , {|x| cSoap := cSoap  +  WSSoapValue("item", x , x , "cardEventDto", .F. , .T., 0 , NIL, .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT ECMWorkflowEngineServiceService_processAttachmentDtoArray
	Local cSoap := ""
	aEval( ::oWSitem , {|x| cSoap := cSoap  +  WSSoapValue("item", x , x , "processAttachmentDto", .F. , .T., 0 , NIL, .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT ECMWorkflowEngineServiceService_stringArrayArray
	Local cSoap := ""
	aEval( ::oWSitem , {|x| cSoap := cSoap  +  WSSoapValue("item", x , x , "stringArray", .F. , .T., 0 , NIL, .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT ECMWorkflowEngineServiceService_processTaskAppointmentDtoArray
	Local cSoap := ""
	aEval( ::oWSitem , {|x| cSoap := cSoap  +  WSSoapValue("item", x , x , "processTaskAppointmentDto", .F. , .T., 0 , NIL, .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT ECMWorkflowEngineServiceService_keyValueDtoArray
	Local cSoap := ""
	aEval( ::oWSitem , {|x| cSoap := cSoap  +  WSSoapValue("item", x , x , "keyValueDto", .F. , .T., 0 , NIL, .F.)  } ) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT ECMWorkflowEngineServiceService_cardEventDto
	Local cSoap := ""
	cSoap += WSSoapValue("eventDescription", ::ceventDescription, ::ceventDescription , "string", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("eventId", ::ceventId, ::ceventId , "string", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("eventVersAnt", ::leventVersAnt, ::leventVersAnt , "boolean", .F. , .T., 0 , NIL, .F.) 
Return cSoap
...
WSMETHOD SOAPSEND WSCLIENT ECMWorkflowEngineServiceService_processAttachmentDto
	Local cSoap := ""
	cSoap += WSSoapValue("attachmentSequence", ::nattachmentSequence, ::nattachmentSequence , "int", .F. , .T., 0 , NIL, .F.) 
	...
	cSoap += WSSoapValue("createDateTimestamp", ::ncreateDateTimestamp, ::ncreateDateTimestamp , "long", .F. , .T., 0 , NIL, .F.) 
	...
	cSoap += WSSoapValue("newAttach", ::lnewAttach, ::lnewAttach , "boolean", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("originalMovementSequence", ::noriginalMovementSequence, ::noriginalMovementSequence , "int", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("permission", ::cpermission, ::cpermission , "string", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, ::nprocessInstanceId , "int", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("size", ::nsize, ::nsize , "float", .F. , .T., 0 , NIL, .F.) 
...
WSMETHOD SOAPSEND WSCLIENT ECMWorkflowEngineServiceService_processTaskAppointmentDto
	Local cSoap := ""
	cSoap += WSSoapValue("appointmentDate", ::cappointmentDate, ::cappointmentDate , "dateTime", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("appointmentSeconds", ::nappointmentSeconds, ::nappointmentSeconds , "int", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("appointmentSequence", ::nappointmentSequence, ::nappointmentSequence , "int", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("colleagueId", ::ccolleagueId, ::ccolleagueId , "string", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("colleagueName", ::ccolleagueName, ::ccolleagueName , "string", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("companyId", ::ncompanyId, ::ncompanyId , "long", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("isNewRecord", ::lisNewRecord, ::lisNewRecord , "boolean", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("movementSequence", ::nmovementSequence, ::nmovementSequence , "int", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, ::nprocessInstanceId , "int", .F. , .T., 0 , NIL, .F.) 
	cSoap += WSSoapValue("transferenceSequence", ::ntransferenceSequence, ::ntransferenceSequence , "int", .F. , .T., 0 , NIL, .F.) 
Return cSoap

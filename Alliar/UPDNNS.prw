...
/*/
//--------------------------------------------------------------------
User Function UPDNNS( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDDESC" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDDESC" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Just. Rejeic'															, ; //X3_TITULO
	'Just. Rechaz'															, ; //X3_TITSPA
	'Rejec Just'															, ; //X3_TITENG
	'Justificativa Rejeição'												, ; //X3_DESCRIC
	'Justifica rechazo'														, ; //X3_DESCSPA
	'Rejection Reason'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	15																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Ident Fluig'															, ; //X3_TITULO
	'Ident Fluig'															, ; //X3_TITSPA
	'Ident Fluig'															, ; //X3_TITENG
	'Ident Fluig'															, ; //X3_DESCRIC
	'Ident Fluig'															, ; //X3_DESCSPA
	'Ident Fluig'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'NNS'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'NNS_FILIAL+NNS_XIDFLG'													, ; //CHAVE
	'Ident Fluig'															, ; //DESCRICAO
	'Ident Fluig'															, ; //DESCSPA
	'Ident Fluig'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
